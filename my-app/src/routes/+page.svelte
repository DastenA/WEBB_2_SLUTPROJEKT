<script>
      import casino from '$lib/images/casino_background.avif';
...
<div class="bg-cover bg-center p-5" style="background-image: url({casino});">
  <section class="p-8 opacity-85 bg-white">
      ...
      <br>
      <p>Now, does that mean you can’t win? Of course not! Every once in a while, someone gets lucky and walks away richer than they came. But if you think you’re going to beat the system in the long run, well... let’s just say we built this place for a reason.</p>
      <br>
